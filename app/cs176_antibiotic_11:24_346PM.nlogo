...
to antibiotic_check
  ...
  [
    if pcolor = 1 [
      if random-float 100 < 80 - fluoroquinolone_resistance [die]
    ]
    if pcolor = 2 [
      if random-float 100 < 60 - fluoroquinolone_resistance [die]
    ]
    if pcolor = 3 [
      if random-float 100 < 40 - fluoroquinolone_resistance [die]
    ]
    if pcolor = 4 [
  ...
  [
    if pcolor = 1 [
      if random-float 100 < 80 - macrolide_resistance [die]
    ]
    if pcolor = 2 [
      if random-float 100 < 60 - macrolide_resistance [die]
    ]
    if pcolor = 3 [
      if random-float 100 < 40 - macrolide_resistance [die]
    ]
    if pcolor = 4 [
  ...
  [
    if pcolor = 1 [
      if random-float 100 < 80 - cephalosporin_resistance [die]
    ]
    if pcolor = 2 [
      if random-float 100 < 60 - cephalosporin_resistance [die]
    ]
    if pcolor = 3 [
      if random-float 100 < 40 - cephalosporin_resistance [die]
    ]
    if pcolor = 4 [
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>count turtles &gt; 1750</exitCondition>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="bacteria_lifespan">
      <value value="109"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-number-bacteria">
      <value value="516"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="petri_dish_antibiotic">
      <value value="&quot;penicillin&quot;"/>
    </enumeratedValueSet>
