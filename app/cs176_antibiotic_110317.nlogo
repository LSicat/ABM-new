...
to transfer-dna
  let choice random 2
  if any? one-of (turtles-on neighborhood)[
    ask one-of (turtles-on neighborhood)[
      if choice = 1 [
...
to transfer_fluoroquinolon [receiver giver]
 ;; set [fluoroquinolone_resistance] of receiver [fluoroquinolone_resistance] of giver
